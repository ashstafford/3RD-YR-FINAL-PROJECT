    ...
    <ul class="menu">
      ...
      <div id="pagecontent2">
        ...
        <form action = "MemberActionServlet" method = "post">
            ...
            <label for="exampleInputEditFirstname">Enter your new First Name: <span style="color:red;">*</span></label>
            </div>
            ...
            <div id="EditsTextboxandButtonPosition">  
               ...
               <input type="hidden" name="action" value="Edit First Name"/>
                 <input type="submit" class="resizedButton" name="submit" value="Edit First Name"/>
