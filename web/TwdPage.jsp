<%-- 
    Document   : TwdPage
    Created on : 15-Dec-2015, 01:07:08
    Author     : Karen
--%>
...
<html>
    <head>
        ...
        <title>TWD Page</title>
        
                
             <style>
body 
            {
             background: url("IMG_TWDBackground.jpg") no-repeat center center fixed; 
        ...
        <div id="pagecontent">    
         <table>
                ...
                <%
                    ...
                    products = (List) (request.getSession().getAttribute("twdProducts"));
