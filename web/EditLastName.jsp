    ...
    <ul class="menu">
      ...
      <div id="pagecontent2">
        ...
        <form action = "MemberActionServlet" method = "post">
            ...
            <label for="exampleInputEditFirstname">Enter your new Last Name: <span style="color:red;">*</span></label>
            </div>
            ...
            <div id="EditsTextboxandButtonPosition">  
               ...
               <input type="hidden" name="action" value="Edit Last Name"/>
                 <input type="submit" class="resizedButton" name="submit" value="Edit Last Name"/>
