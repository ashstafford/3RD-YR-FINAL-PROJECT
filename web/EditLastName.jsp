<%-- 
    Document   : EditLastName
    Created on : 14-Dec-2015, 21:52:13
    Author     : Aisling
--%>
    ...
    <ul class="menu">
      ...
      <div id="pagecontent3">
        ...
        <form action = "MemberActionServlet" method = "post">
            ...
            <label for="exampleInputEditFirstname"><%=messages.getString("newLastNameLabel")%>: <span style="color:red;">*</span></label>
            </div>
               
            <div id="EditsTextboxandButtonPosition">  
               <input name="editLastName" class="resizedTextBox" size=15 />
               
               <input type="hidden" name="action" value="Edit Last Name"/>
                 <input type="submit" class="resizedButton" name="submit" value="<%=messages.getString("newLastNameLabel")%>"/>
