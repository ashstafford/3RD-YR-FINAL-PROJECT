    ...
    <ul class="menu">
      ...
      <div id="pagecontent3">
        ...
        <form action = "MemberActionServlet" method = "post">
            ...
            <label for="exampleInputEditFirstname"><%=messages.getString("newPasswordLabel")%>: <span style="color:red;">*</span></label>
            </div>
            ...
            <div id="EditsTextboxandButtonPosition">  
               ...
               <input type="submit" class="resizedButton" name="submit" value="<%=messages.getString("EditPasswordLabel")%>"/>
